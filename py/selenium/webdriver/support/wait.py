...
class WebDriverWait:
    def __init__(
        self,
        driver: typing.Type[RemoteWebDriver],
        timeout: float,
    ...
    UntilMethodType = typing.Callable[[typing.Type[RemoteWebDriver]], typing.Any]

    def until(self, method: UntilMethodType, message: str = ""):
    ...
    def until_not(self, method: UntilMethodType, message: str = ""):
        """Calls the method provided with the driver as an argument until the \
